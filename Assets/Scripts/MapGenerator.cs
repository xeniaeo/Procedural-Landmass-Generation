...
public class MapGenerator : MonoBehaviour
{
    ...
    void MapDataThread(Vector2 centre, Action<MapData> callback) {
        ...
        // Add this mapData along with the callback into a queue
        // Use lock to make sure no other thread can execute this at the same time
    ...
    // Use generic type to deal with mapData & meshData
